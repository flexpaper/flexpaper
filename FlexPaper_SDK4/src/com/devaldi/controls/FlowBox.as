...
package com.devaldi.controls
{
	...
	public class FlowBox extends Box
	{
		...
		public function FlowBox(_scale:Number = 1)
		{
			this._scale = _scale;
...
//hkh			subContainer.verticalScrollPolicy = "off";
//			subContainer.horizontalScrollPolicy = "off";
			return subContainer;
		}
		...
		private function canFit( child:DisplayObject, parent:Box ):Boolean
		{
			...
			{
				usedSpace += gap + existingChild[criticalDimension] * _scale;
			}

			var requiredSpace:Number = usedSpace + gap + child[criticalDimension] * _scale;
