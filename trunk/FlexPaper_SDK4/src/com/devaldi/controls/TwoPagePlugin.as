	...
	public class TwoPagePlugin implements IFlexPaperViewModePlugin, IEventDispatcher{
		...
		public function addChild(i:int,o:DisplayObject):void{
			if(i==0 || i==1){
				...
				viewer.PaperContainer.setStyle("horizontalAlign", "center");
			}
		}
...
//			viewer.PaperContainer.setStyle("horizontalAlign", "left");
//hkh			viewer.DisplayContainer.setStyle("horizontalAlign", "center");
//			viewer.DisplayContainer.setStyle("horizontalGap",1);
			viewer.DisplayContainer.autoLayout = true;
